...
function _prepareStackTrace() {
  _prepareStackTrace = (0, _asyncToGenerator2.default)(function* (error, source) {
    const newError = new ErrorWithCodeFrame(error);
    const map = yield new _sourceMap.SourceMapConsumer((0, _fs.readFileSync)(source, `utf8`));
